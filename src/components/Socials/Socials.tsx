...
const enum ESocials {
    GITHUB_URL = "http://github.com/JoelSamson",
    INSTAGRAM_URL = "https://www.instagram.com/joelsamsonxd/",
    LINKEDIN_URL = "https://www.linkedin.com/in/joelsamson",
    MEDIUM_URL = "https://medium.com/@joelsamson2014",
    CODEPEN_URL = "https://codepen.io/DragneelXD2000"
}
...
export const SocialIcons: React.FC = () => {
    return (
        <>
            ...
            <HoverIconLink href={ESocials.MEDIUM_URL} target="_blank">
                <AiOutlineMedium />
            </HoverIconLink>
        </>
    );
